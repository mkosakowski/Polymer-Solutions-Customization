report 50105 "RSMUSReturn Authorization"
//9934 CMH  8/16/22 BRD-0021: Created custom report to include company logo, custom header, and packaging field
{
    DefaultLayout = RDLC;
    RDLCLayout = './src/Report/Layouts/Rep50105.RSMUSReturnAuthorization.rdl';
    ...
    dataset
    {
        dataitem("Sales Header"; "Sales Header")
        {
            ...
            column(RSMUSCompanyPic; gCompany."Picture") //add company picture
            {
            }
            ...
            dataitem(CopyLoop; "Integer")
            {
                ...
                dataitem(PageLoop; "Integer")
                {
                    ...
                    column(Sales_Header___Shipment_Date_; Format("Sales Header"."Shipment Date", 0, '<Month,2>/<Day,2>/<Year4>'))
                    {
                    }
                    ...
                    column(Sales_Header___Document_Date_; Format("Sales Header"."Document Date", 0, '<Month,2>/<Day,2>/<Year4>'))
                    {
                    }
                    ...
                    column(Sales_Header___Order_Date_; Format("Sales Header"."Order Date", 0, '<Month,2>/<Day,2>/<Year4>'))
                    {
                    }
                    ...
                    dataitem(SalesLine; "Integer")
                    {
                        ...
                        column(RSMUSPackaging; TempSalesLine."RSMUS Packaging") //add packaging field
                        {
                        }
                        ...
                        column(RSMUSUnitPrice; TempSalesLine."Unit Price")
                        {
                        }
                        column(RSMUSTotalPrice; TempSalesLine."Line Amount")
                        {
                        }
                        column(RSMUSItemRef; TempSalesLine."Item Reference No.")
                        {
                        }

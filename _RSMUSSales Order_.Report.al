report 50103 "RSMUSSales Order"
{
    //9931 CMH 8/15/22 REP 10075: Converted from previous sales order rep ext to custom rpt
    DefaultLayout = RDLC;
    RDLCLayout = './src/Report/Layouts/Rep50103.RSMUSSalesOrder.rdl';
    Caption = 'Sales Order';
    ...
    dataset
    {
        dataitem("Sales Header"; "Sales Header")
        {
            ...
            column(RSMUSPromised_Delivery_Date; Format("Promised Delivery Date", 0, '<Month,2>/<Day,2>/<Year4>'))
            {
            }
            column(RSMUSRequested_Delivery_Date; Format("Requested Delivery Date", 0, '<Month,2>/<Day,2>/<Year4>'))
            {
            }
            ...
            dataitem(CopyLoop; "Integer")
            {
                ...
                dataitem(PageLoop; "Integer")
                {
                    ...
                    column(ShptDate_SalesHeader; Format("Sales Header"."Shipment Date", 0, '<Month,2>/<Day,2>/<Year4>'))
                    {
                    }
    ...
    procedure RSMUSSalesHeaderShipTo(var AddrArray: array[8] of Text[100]; CustAddr: array[8] of Text[100]; var SalesHeader: Record "Sales Header") Result: Boolean
    var

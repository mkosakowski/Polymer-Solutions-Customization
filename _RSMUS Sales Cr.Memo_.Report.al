report 50109 "RSMUS Sales Cr.Memo"
{
    //RSM9935 MGZ 10/11/2022 BRD-0023: Geneis: built off of 10073 Sales Credit Memo NA, field in lines prevents using ext.
    DefaultLayout = RDLC;
    RDLCLayout = './src/Report/Layouts/Rep50109.RSMUSSalesCrMemo.rdl';
            ...
            dataitem(CopyLoop; "Integer")
            {
                ...
                dataitem(PageLoop; "Integer")
                {
                    ...
                    dataitem(SalesCrMemoLine; "Integer")
                    {
                        ...
                        column(RSMUSItemRefNo; TempSalesCrMemoLine."Item Reference No.")
                        {
                        }
                        column(RSMUSPackaging; TempSalesCrMemoLine."RSMUS Packaging")
                        {
                        }
                        column(TempSalesCrMemoLineNo; TempSalesCrMemoLine."No.")
                        {
                        }
                        column(TempSalesCrMemoLineUOM; TempSalesCrMemoLine."Unit of Measure Code")
                        {
                        }
                        ...
                        begin
                            ...
                            if TempSalesCrMemoLine.Amount <> TempSalesCrMemoLine."Amount Including VAT" then TaxLiable:=TempSalesCrMemoLine.Amount
                            else
                                TaxLiable:=0;
                            AmountExclInvDisc:=TempSalesCrMemoLine.Amount + TempSalesCrMemoLine."Inv. Discount Amount";
                            if TempSalesCrMemoLine.Quantity = 0 then UnitPriceToPrint:=0
                            // so it won't print
                            else
 ...
 Clear(CopyTxt)
            ...
            begin
                ...
                RSMUSSalesCrMemoBillTo(BillToAddress, "Sales Cr.Memo Header");
                RSMUSSalesCrMemoShipTo(ShipToAddress, ShipToAddress, "Sales Cr.Memo Header");
                ...
                if ShipmentMethod.Get("Sales Cr.Memo Header"."Shipment Method Code")then RSMUSShipmentMethodDescription:=ShipmentMethod.Description;
                if ShippingAgent.Get("Sales Cr.Memo Header"."Shipping Agent Code")then RSMUSShippingAgentName:=ShippingAgent.Name;
                if ShippingAgentServices.Get("Sales Cr.Memo Header"."Shipping Agent Code", "Sales Cr.Memo Header"."Shipping Agent Service Code")then RSMUSShippingAgentServiceDescription:=ShippingAgentServices.Description;
            end;
        }
    }
    requestpage
    ...
    procedure RSMUSSalesCrMemoBillTo(var AddrArray: array[8]of Text[100]; var SalesCrMemoHeader: Record "Sales Cr.Memo Header")
    begin
        FormatAddress.FormatAddr(AddrArray, SalesCrMemoHeader."Bill-to Name", '', SalesCrMemoHeader."Bill-to Contact", SalesCrMemoHeader."Bill-to Address", SalesCrMemoHeader."Bill-to Address 2", SalesCrMemoHeader."Bill-to City", SalesCrMemoHeader."Bill-to Post Code", SalesCrMemoHeader."Bill-to County", SalesCrMemoHeader."Bill-to Country/Region Code");
    end;
    procedure RSMUSSalesCrMemoShipTo(var AddrArray: array[8]of Text[100]; CustAddr: array[8]of Text[100]; var SalesCrMemoHeader: Record "Sales Cr.Memo Header")Result: Boolean var
        i: Integer;
    begin
        FormatAddress.FormatAddr(AddrArray, SalesCrMemoHeader."Ship-to Name", '', SalesCrMemoHeader."Ship-to Contact", SalesCrMemoHeader."Ship-to Address", SalesCrMemoHeader."Ship-to Address 2", SalesCrMemoHeader."Ship-to City", SalesCrMemoHeader."Ship-to Post Code", SalesCrMemoHeader."Ship-to County", SalesCrMemoHeader."Ship-to Country/Region Code");
